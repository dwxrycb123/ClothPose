                                 ...
                                 const Eigen::Matrix<double, 1, dim>& v2)
{
    ...
    Eigen::Matrix<double, 2, 1> pt2D01 =
        (basis * basis.transpose()).ldlt().solve(basis * vect.transpose());

    return pointInTriangle(pt2D01[0], pt2D01[1]);
}

inline void d_PP(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 double& d)
{
    // cout << "v0: " << v0 << endl;
    // cout << "v1: " << v1 << endl;
...
inline void g_PP(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
...
inline void d_PE(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 const Eigen::RowVector3d& v2, double& d)
{
    d = (v1 - v0).cross(v2 - v0).squaredNorm() / (v2 - v1).squaredNorm();
}

inline void g_PE(double v01, double v02, double v03, double v11, double v12,
                 double v13, double v21, double v22, double v23, double g[9])
{
    double t17;
    double t18;
    double t19;
...
inline void g_PE(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 const Eigen::RowVector3d& v2, Eigen::Matrix<double, 9, 1>& g)
{
    g_PE(v0[0], v0[1], v0[2], v1[0], v1[1], v1[2], v2[0], v2[1], v2[2],
         g.data());
}

inline void H_PE(double v01, double v02, double v03, double v11, double v12,
                 double v13, double v21, double v22, double v23, double H[81])
{
    double t17;
    double t18;
    double t19;
...
inline void H_PE(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 const Eigen::RowVector3d& v2, Eigen::Matrix<double, 9, 9>& H)
{
    H_PE(v0[0], v0[1], v0[2], v1[0], v1[1], v1[2], v2[0], v2[1], v2[2],
         H.data());
}
...
inline void d_PT(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
...
inline void g_PT(double v01, double v02, double v03, double v11, double v12,
                 double v13, double v21, double v22, double v23, double v31,
                 double v32, double v33, double g[12])
{
    double t11;
    double t12;
    double t13;
...
inline void g_PT(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 const Eigen::RowVector3d& v2, const Eigen::RowVector3d& v3,
                 Eigen::Matrix<double, 12, 1>& g)
{
    g_PT(v0[0], v0[1], v0[2], v1[0], v1[1], v1[2], v2[0], v2[1], v2[2], v3[0],
         v3[1], v3[2], g.data());
}

inline void H_PT(double v01, double v02, double v03, double v11, double v12,
                 double v13, double v21, double v22, double v23, double v31,
                 double v32, double v33, double H[144])
{
    double t11;
    double t12;
    double t13;
    ...
    t615 =
        (-(t125 * t135 * t202 * 2.0) + -t318) + t135 * t193 * t203 * t205 * 2.0;
    t616 =
        (-(t128 * t133 * t202 * 2.0) + -t321) + t133 * t195 * t203 * t205 * 2.0;
    ...
    t625 =
        (-(t135 * t189 * t202 * 2.0) + -t325) + t135 * t197 * t203 * t205 * 2.0;
    ...
    t608 =
        (t125 * t133 * t202 * 2.0 + t316) + -(t133 * t193 * t203 * t205 * 2.0);
    t612 =
        (t128 * t135 * t202 * 2.0 + t322) + -(t135 * t195 * t203 * t205 * 2.0);
    ...
    t620 =
        (t133 * t189 * t202 * 2.0 + t324) + -(t133 * t197 * t203 * t205 * 2.0);
...
inline void H_PT(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 const Eigen::RowVector3d& v2, const Eigen::RowVector3d& v3,
                 Eigen::Matrix<double, 12, 12>& H)
{
    H_PT(v0[0], v0[1], v0[2], v1[0], v1[1], v1[2], v2[0], v2[1], v2[2], v3[0],
         v3[1], v3[2], H.data());
}
...
inline void d_EE(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 const Eigen::RowVector3d& v2, const Eigen::RowVector3d& v3,
                 double& d)
{
...
inline void g_EE(double v01, double v02, double v03, double v11, double v12,
                 double v13, double v21, double v22, double v23, double v31,
                 double v32, double v33, double g[12])
{
    double t11;
...
inline void g_EE(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 const Eigen::RowVector3d& v2, const Eigen::RowVector3d& v3,
                 Eigen::Matrix<double, 12, 1>& g)
{
    g_EE(v0[0], v0[1], v0[2], v1[0], v1[1], v1[2], v2[0], v2[1], v2[2], v3[0],
         v3[1], v3[2], g.data());
}

inline void H_EE(double v01, double v02, double v03, double v11, double v12,
                 double v13, double v21, double v22, double v23, double v31,
                 double v32, double v33, double H[144])
{
    double t11;
    ...
    t522 =
        (((-(t98 * t137 * t156 * 2.0) + t310) + -t341) + -(b_t522_tmp * 2.0)) +
        -(t522_tmp * 2.0);
    t523_tmp = t138 * t147 * t157 * t159;
    b_t523_tmp = t99 * t147 * t157 * t159;
    t523 = (((-(t99 * t138 * t156 * 2.0) + t311) + -t345) + b_t523_tmp * 2.0) +
           t523_tmp * 2.0;
    ...
    t146 =
        ((((t100 * t107 * t156 * 2.0 + t266) + t327) + -t358) + -t369) + t491;
    t145 =
        ((((-(t99 * t107 * t156 * 2.0) + -t265) + t329) + t367) + t386) + -t503;
    t144 = ((((-(t100 * t108 * t156 * 2.0) + -t267) + t325) + t360) + -t399) +
           t499;
    t143 =
        ((((-(t99 * t109 * t156 * 2.0) + t267) + t335) + -t362) + t398) + t500;
    t52 =
        ((((-(t98 * t108 * t156 * 2.0) + t265) + t339) + -t27) + -t387) + -t504;
    ...
    t48 =
        ((((-(t100 * t137 * t156 * 2.0) + -t263) + -t299) + -t65) + t73) + t47;
    t47 = ((((t99 * t137 * t156 * 2.0 + t262) + -t300) + t356) + -t446) + -t497;
    t73 =
        ((((t100 * t138 * t156 * 2.0 + t264) + -t298) + -t382) + -t423) + t495;
    t65 = ((((-(t109 * t141 * t156 * 2.0) + t279) + -t301) + t408) + -t441) +
          t506;
    t59 =
        ((((t98 * t138 * t156 * 2.0 + -t262) + -t300) + -t377) + t424) + -t497;
    t40 =
        ((((t99 * t139 * t156 * 2.0 + -t264) + -t298) + -t353) + -t451) + t495;
    ...
    t35 = ((((-(t109 * t137 * t156 * 2.0) + t270) + t328) + -t368) + -t428) +
          -t492;
    t28 =
        ((((t100 * t140 * t156 * 2.0 + -t271) + -t327) + t369) + -t427) + -t491;
    t27 =
        ((((-(t98 * t141 * t156 * 2.0) + -t269) + t330) + t387) + -t433) + t504;
    t26 =
        ((((t109 * t138 * t156 * 2.0 + -t272) + t326) + -t398) + t432) + -t500;
    t13 = ((((-(t107 * t139 * t156 * 2.0) + -t270) + -t327) + t358) + t438) +
          -t491;
    t12 =
        ((((-(t99 * t142 * t156 * 2.0) + -t273) + t326) + t362) + t467) + -t500;
    t11 =
        ((((-(t99 * t140 * t156 * 2.0) + t269) + -t329) + -t367) + t455) + t503;
    t16 =
        ((((t107 * t138 * t156 * 2.0 + t268) + -t329) + -t386) + -t434) + t503;
    t15 = ((((-(t100 * t141 * t156 * 2.0) + t273) + -t325) + t399) + t431) +
          -t499;
    t14 =
        ((((t108 * t139 * t156 * 2.0 + t272) + -t325) + -t360) + t468) + -t499;
    t105 =
        ((((-(t139 * t140 * t156 * 2.0) + t275) + t327) + t427) + -t438) + t491;
    t103 =
        ((((t138 * t140 * t156 * 2.0 + -t274) + t329) + t434) + -t455) + -t503;
    t101 = ((((-(t137 * t142 * t156 * 2.0) + -t275) + t337) + t428) + -t437) +
           t492;
    t58 =
        ((((t139 * t141 * t156 * 2.0 + -t276) + t325) + -t431) + -t468) + t499;
...
inline void H_EE(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                 const Eigen::RowVector3d& v2, const Eigen::RowVector3d& v3,
                 Eigen::Matrix<double, 12, 12>& H)
{
    H_EE(v0[0], v0[1], v0[2], v1[0], v1[1], v1[2], v2[0], v2[1], v2[2], v3[0],
         v3[1], v3[2], H.data());
}
...
inline int dType_EE(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                    const Eigen::RowVector3d& v2, const Eigen::RowVector3d& v3)
{
...
inline int dType_PT(const Eigen::RowVector3d& v0, const Eigen::RowVector3d& v1,
                    const Eigen::RowVector3d& v2, const Eigen::RowVector3d& v3)
{
    ...
    param.col(0) =
        (basis * basis.transpose()).ldlt().solve(basis * (v0 - v1).transpose());
...
inline void checkDType(void)
{
    ...
    for (const auto& testI : testData)
    {
        ...
        std::cout << "PT: " << dType_PT(testI[0], testI[1], testI[2], testI[3])
                  << std::endl;
        std::cout << "EE: " << dType_EE(testI[0], testI[1], testI[2], testI[3])
                  << std::endl;
...
inline void computePointTriD(const Eigen::RowVector3d& v0,
                             ...
                             const Eigen::RowVector3d& v3, double& d)
{
...
inline void computeEECrossSqNorm(const Eigen::RowVector3d& v0,
                                 const Eigen::RowVector3d& v1,
                                 const Eigen::RowVector3d& v2,
                                 const Eigen::RowVector3d& v3, double& result)
{
    result = (v1 - v0).cross(v3 - v2).squaredNorm();
}

inline void computeEECrossSqNormGradient(double v01, double v02, double v03,
                                         ...
                                         double g[12])
{
    ...
    /*     G =
     * COMPUTEEECROSSSQNORMGRADIENT(V01,V02,V03,V11,V12,V13,V21,V22,V23,V31,V32,V33)
     */
    /*     This function was generated by the Symbolic Math Toolbox version 8.3.
     */
...
inline void computeEECrossSqNormGradient(const Eigen::RowVector3d& v0,
                                         const Eigen::RowVector3d& v1,
                                         const Eigen::RowVector3d& v2,
                                         const Eigen::RowVector3d& v3,
                                         Eigen::Matrix<double, 12, 1>& grad)
{
    computeEECrossSqNormGradient(v0[0], v0[1], v0[2], v1[0], v1[1], v1[2],
                                 v2[0], v2[1], v2[2], v3[0], v3[1], v3[2],
                                 grad.data());
}

inline void computeEECrossSqNormHessian(double v01, double v02, double v03,
                                        double v11, double v12, double v13,
                                        double v21, double v22, double v23,
                                        double v31, double v32, double v33,
                                        double H[144])
{
    ...
    /*     H =
     * COMPUTEEECROSSSQNORMHESSIAN(V01,V02,V03,V11,V12,V13,V21,V22,V23,V31,V32,V33)
     */
    /*     This function was generated by the Symbolic Math Toolbox version 8.3.
     */
    /*     01-Nov-2019 16:54:23 */
...
inline void computeEECrossSqNormHessian(const Eigen::RowVector3d& v0,
                                        const Eigen::RowVector3d& v1,
                                        const Eigen::RowVector3d& v2,
                                        const Eigen::RowVector3d& v3,
                                        Eigen::Matrix<double, 12, 12>& Hessian)
{
    computeEECrossSqNormHessian(v0[0], v0[1], v0[2], v1[0], v1[1], v1[2], v2[0],
...
inline void compute_e(const Eigen::RowVector3d& v0,
                      const Eigen::RowVector3d& v1,
                      const Eigen::RowVector3d& v2,
                      const Eigen::RowVector3d& v3, double eps_x, double& e)
{
...
inline void compute_e_g(const Eigen::RowVector3d& v0,
                        const Eigen::RowVector3d& v1,
                        const Eigen::RowVector3d& v2,
                        const Eigen::RowVector3d& v3, double eps_x,
                        Eigen::Matrix<double, 12, 1>& g)
{
    double EECrossSqNorm;
    computeEECrossSqNorm(v0, v1, v2, v3, EECrossSqNorm);
...
inline void compute_e_H(const Eigen::RowVector3d& v0,
                        const Eigen::RowVector3d& v1,
                        const Eigen::RowVector3d& v2,
                        const Eigen::RowVector3d& v3, double eps_x,
                        Eigen::Matrix<double, 12, 12>& H)
...
inline void compute_eps_x(const cp::TriMesh& mesh, int eI0, int eI1, int eJ0,
                          int eJ1, double& eps_x)
{
    eps_x = 1.0e-3 *
            (mesh.vertices.row(eI0) - mesh.vertices.row(eI1)).squaredNorm() *
            (mesh.vertices.row(eJ0) - mesh.vertices.row(eJ1)).squaredNorm();
}

inline void compute_eps_x(const cp::TriMesh& mesh, const Eigen::MatrixXd& V_MCO,
                          int eI0, int eI1, int eJ0, int eJ1, double& eps_x)
{
    eps_x = 1.0e-3 *
            (mesh.vertices.row(eI0) - mesh.vertices.row(eI1)).squaredNorm() *
            (V_MCO.row(eJ0) - V_MCO.row(eJ1)).squaredNorm();
}
