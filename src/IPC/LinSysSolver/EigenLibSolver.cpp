...
void EigenLibSolver<vectorTypeI, vectorTypeS>::set_pattern(
...
template <typename vectorTypeI, typename vectorTypeS>
double EigenLibSolver<vectorTypeI, vectorTypeS>::coeffMtr(int rowI,
                                                          int colI) const
{
...
template <typename vectorTypeI, typename vectorTypeS>
void EigenLibSolver<vectorTypeI, vectorTypeS>::setCoeff(int rowI, int colI,
                                                        double val)
{
    if (rowI <= colI)
    {
...
template <typename vectorTypeI, typename vectorTypeS>
void EigenLibSolver<vectorTypeI, vectorTypeS>::addCoeff(int rowI, int colI,
                                                        double val)
{
    if (rowI <= colI)
    {
...
template <typename vectorTypeI, typename vectorTypeS>
void EigenLibSolver<vectorTypeI, vectorTypeS>::setUnit_col(
