...
class ARAPEnergy:
    def __init__(
        self, rest_mesh: Mesh, weight: float, boundary_weight: float
    ) -> None: ...
...
class L2Energy:
    def __init__(
        self, anchor_inds: numpy.ndarray[numpy.int32], weight: float
    ) -> None: ...
...
class Mesh:
    ...
    def __init__(
        ...
        triangles: numpy.ndarray[numpy.int32],
    ) -> None: ...
    def clone(self) -> Mesh:
        """
...
class Optimizer:
    def __init__(
        ...
        energies: list[
            ARAPEnergy | L2Energy | Mesh2PointEnergy | Point2MeshEnergy | BarrierEnergy
        ],
        rel_newton_res: float,
    ) -> None: ...
    ...
    def setup_ignored_collision_pairs(self) -> None: ...
